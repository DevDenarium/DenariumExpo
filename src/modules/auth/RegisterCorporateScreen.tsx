...
import { registerCorporate, getCountries, getProvinces, getCantons, getDistricts } from '../../services/auth.service';
import Icon from 'react-native-vector-icons/MaterialCommunityIcons';
import { StackNavigationProp } from '@react-navigation/stack';
import { RootStackParamList } from '../navegation/Navegation.types';
import { UserRole } from "./user.types";

type RegisterCorporateScreenProps = {
...
const RegisterCorporateScreen = ({ navigation }: RegisterCorporateScreenProps) => {
    ...
    const handleSubmit = async () => {
        if (!formData.email || !formData.password || !formData.confirmPassword ||
            !formData.companyName || !formData.phone || !formData.contactName ||
            !formData.contactPhone || !formData.country || !formData.employeeCount ||
        ...
        if (!validateDomain(formData.companyDomain)) {
            setError('Por favor ingresa un dominio válido (ejemplo: empresa.com)');
            return;
        }
        ...
        if (!validatePhone(formData.contactPhone)) {
            setError('Por favor ingresa un número de teléfono de contacto válido');
            return;
        }

        const employeeCount = parseInt(formData.employeeCount);
        if (isNaN(employeeCount)) {
            setError('Por favor ingresa un número válido de empleados');
            return;
        }
    ...
    return (
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
            <View style={styles.titleContainer}>
                <Text style={styles.title}>Cuenta Corporativa</Text>
            </View>
            ...
            <View style={styles.inputContainer}>
                <TextInput
                    style={[
                        styles.input,
                        !formData.companyName && touchedFields.companyName && styles.inputError
                    ]}
                    placeholder="Nombre de la empresa *"
                    placeholderTextColor="#555555"
                    value={formData.companyName}
                    onChangeText={(companyName) => setFormData({ ...formData, companyName })}
            ...
            <View style={styles.inputContainer}>
                <TextInput
                    style={[
                        styles.input,
                        !formData.contactName && touchedFields.contactName && styles.inputError
                    ]}
                    placeholder="Nombre del contacto *"
                    placeholderTextColor="#555555"
                    value={formData.contactName}
                    onChangeText={(contactName) => setFormData({ ...formData, contactName })}
            ...
            <View style={styles.inputContainer}>
                <TextInput
                    style={[
                        styles.input,
                        (!formData.contactPhone || !validatePhone(formData.contactPhone)) && touchedFields.contactPhone && styles.inputError
                    ]}
                    placeholder="Teléfono del contacto *"
                    placeholderTextColor="#555555"
                    keyboardType="phone-pad"
                    value={formData.contactPhone}
                    onChangeText={(contactPhone) => setFormData({ ...formData, contactPhone })}
            ...
            <View style={styles.inputContainer}>
                <TextInput
                    style={[
                        styles.input,
                        (!formData.companyDomain || !validateDomain(formData.companyDomain)) && touchedFields.companyDomain && styles.inputError
                    ]}
                    placeholder="Dominio empresarial (ej: empresa.com) *"
                    placeholderTextColor="#555555"
                    autoCapitalize="none"
                    value={formData.companyDomain}
                    onChangeText={(companyDomain) => setFormData({ ...formData, companyDomain })}
                    onBlur={() => handleFieldTouch('companyDomain')}
                    editable={!loading}
                    returnKeyType="next"
                />
            </View>
            ...
            <View style={styles.inputContainer}>
                <TextInput
                    style={[
                        styles.input,
                        (!formData.employeeCount || isNaN(parseInt(formData.employeeCount))) && touchedFields.employeeCount && styles.inputError
                    ]}
                    placeholder="Número de empleados *"
                    placeholderTextColor="#555555"
                    keyboardType="numeric"
                    value={formData.employeeCount}
                    onChangeText={(employeeCount) => setFormData({ ...formData, employeeCount })}
                    onBlur={() => handleFieldTouch('employeeCount')}
                    editable={!loading}
                    returnKeyType="next"
                />
            </View>
...
export default RegisterCorporateScreen;
